...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      'relative z-10 flex max-w-max rounded-base font-bold border-border dark:border-darkBorder border-2 p-1 bg-main flex-1 items-center justify-center',
      className,
    )}
    {...props}
  >
...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-10 w-max items-center justify-center text-text rounded-md bg-main px-4 py-2 text-sm font-bold transition-colors focus:outline-hidden disabled:pointer-events-none disabled:opacity-50',
)
